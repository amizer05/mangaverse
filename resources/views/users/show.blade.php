                ...
                <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                        ...
                        <a href="{{ route('mangas.public.show', $manga->slug) }}" class="group cursor-pointer">
                            <div class="aspect-[3/4] bg-gradient-to-br from-slate-700 to-slate-800 rounded-lg overflow-hidden border border-slate-600 group-hover:border-indigo-500/50 transition-all duration-200 relative">
