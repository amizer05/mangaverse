    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <div class="flex items-center justify-center gap-4 text-sm text-slate-500">
                <a href="{{ route('faq.index') }}" class="flex items-center gap-2 text-indigo-400 hover:text-indigo-300 transition-colors">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-1 space-y-6">
                ...
                <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                    ...
                    <a href="mailto:support@mangaverse.com" class="text-indigo-400 hover:text-indigo-300 text-sm font-medium">
                ...
                <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                    ...
                    <a href="tel:+81312345678" class="text-indigo-400 hover:text-indigo-300 text-sm font-medium">
                        +81 (3) 1234-5678
                    </a>
                </div>
                ...
                <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                    ...
                    <div class="flex gap-3">
                        <a href="#" class="w-10 h-10 bg-slate-700 hover:bg-indigo-600 rounded-lg flex items-center justify-center transition-colors duration-200">
                            <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                            </svg>
                        </a>
                        <a href="#" class="w-10 h-10 bg-slate-700 hover:bg-blue-800 rounded-lg flex items-center justify-center transition-colors duration-200">
                            <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                            </svg>
                        </a>
                        <a href="#" class="w-10 h-10 bg-slate-700 hover:bg-purple-600 rounded-lg flex items-center justify-center transition-colors duration-200">
                            <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="md:col-span-2">
                <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-8">
                    <!-- Success Message -->
                    @if(session('success'))
                    <div class="mb-6 p-4 bg-green-500/10 border border-green-500/50 rounded-lg flex items-start">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6" x-data="{ 
                        ...
                        maxLength: 2000,
                        updateLength() { this.messageLength = document.getElementById('message').value.length; }
                    }" @submit="loading = true">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 @error('name') border-rose-500 @enderror"
                        ...
                        <div>
                            ...
                            <input type="email" 
                                   ...
                                   class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 @error('email') border-rose-500 @enderror"
                        ...
                        <div>
                            ...
                            <div x-data="{ 
                                ...
                                init() {
                                    // Check if old value is a custom value (not in the dropdown options)
                                    const predefinedOptions = ['General Inquiry', 'Technical Support', 'Account Help', 'Manga Request', 'Bug Report', 'Feature Request', 'Partnership', 'Other'];
                                ...
                                <div class="relative" x-show="!showCustom">
                                    <select id="subject" 
                                            ...
                                            @change="showCustom = $event.target.value === 'Other'; if (showCustom) { selectedValue = ''; }"
                                            :required="!showCustom"
                                            :disabled="showCustom"
                                        ...
                                        <option value="Manga Request" {{ old('subject') == 'Manga Request' ? 'selected' : '' }}>Manga Request</option>
                        ...
                        <div>
                            <label for="message" class="block text-sm font-medium text-slate-300 mb-2">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-xs text-slate-500" :class="messageLength > maxLength * 0.9 ? 'text-yellow-400' : ''">
                            ...
                            <textarea id="message" 
                                      name="message" 
                                      rows="6"
                                      x-on:input="updateLength()"
                                      maxlength="2000"
                                      class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 resize-none @error('message') border-rose-500 @enderror"
                        ...
                        <div class="flex items-center justify-between pt-4">
                            ...
                            <button type="submit" 
                                    :disabled="loading"
                                    class="px-8 py-4 bg-gradient-to-r from-indigo-600 to-rose-600 hover:from-indigo-500 hover:to-rose-500 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl text-white font-semibold transition-all duration-200 transform hover:scale-105 shadow-lg flex items-center gap-2">
