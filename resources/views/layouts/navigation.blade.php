<nav x-data="{ open: false }" class="bg-gray-800/50 backdrop-blur-sm border-b border-gray-700/50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-300 hover:bg-gray-700/50 focus:outline-none focus:bg-gray-700/50 focus:text-gray-300 transition duration-150 ease-in-out">
